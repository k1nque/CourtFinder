...
from Handlers.routes.hierarchy_route import HierarchyRouter
from Handlers.routes.areal_route import ArealRouter
from Handlers.routes.choice_route import ChoiceRouter
from Handlers.routes.start_route import StartRouter
from Handlers.routes.two_questions_route import TwoQuestionsRouter
...
# @_user_private_router.message(CommandStart())
...
# @_user_private_router.message(StateFilter(None), Command("start_test"))
...
# @_user_private_router.message(StateFilter(Test.IsItCriminalCase), F.text == "Нет")
...
# @_user_private_router.message(StateFilter(Test.IsItMilitaryServiceCase), F.text == "Нет")
...
# @_user_private_router.message(StateFilter(Test.IsItIntellectualCase), F.text == "Да")
...
# @_user_private_router.message(StateFilter(Test.IsItLegalProtectionCase), F.text == "Нет")
...
# @_user_private_router.message(StateFilter(Test.FOIP_ActsChallengeCase), F.text == "Нет")
...
# @_user_private_router.message(StateFilter(Test.IsItLegalProtectionCase), F.text == "Да")

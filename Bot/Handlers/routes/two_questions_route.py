...
from start_route import StartRouteStates
...
@TwoQuestionsRouter.message(StateFilter(StartRouteStates.IsItMilitaryServiceCase), Text="Нет")
...
@TwoQuestionsRouter.message(StateFilter(TwoQuestionsRouteStates.IsItCounterclaim), Text="Да")
...
@TwoQuestionsRouter.message(StateFilter(TwoQuestionsRouteStates.IsItCounterclaim), Text="Нет")
...
@TwoQuestionsRouter.message(StateFilter(TwoQuestionsRouteStates.IsItIntellectualCase), Text="Что это?")
